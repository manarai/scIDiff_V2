...
CSV = Path("/Users/terooatt/Downloads/scJDO/Figures_notebook/results/benchmark/benchmark_scores.csv")
FIG3_DIR = Path("/Users/terooatt/Downloads/scJDO/Figures_notebook/results/figure3_fa")
...
def main():
    ...
    out.to_csv("/Users/terooatt/Downloads/scJDO/scratchpad_run/fa_composite_reanalysis.csv",
               index=False)
    print("\nSaved: /Users/terooatt/Downloads/scJDO/scratchpad_run/fa_composite_reanalysis.csv")
