...
# ── Paths ────────────────────────────────────────────────────────────────
import os
DATA_DIR = os.environ.get("SCJDO_MULTIOME_MTX_DIR", "") or \
    "/Users/terooatt/Documents/Project_scQDiff/02_scQDiff/scIDIFF_anndata/data/multiomic/filtered_feature_bc_matrix"
if not Path(DATA_DIR).exists():
    raise FileNotFoundError(
        f"Multiome filtered_feature_bc_matrix not found at {DATA_DIR}. "
        f"Set SCJDO_MULTIOME_MTX_DIR env var or see final_manuscript/DATA.md §5."
    )
FIG6_DIR = str(REPO / "Figures_notebook" / "results" / "figure6_multiome_fa")
DRIFT_CC_H5AD = str(REPO / "Figures_notebook" / "results" / "figure6_multiome_fa_drift_cc" / "adata_multiome_drift_cc.h5ad")
OUTDIR = REPO / "analysis" / "results" / "supp_multiome" / "uncorrected_pipeline"
...
shipped_uncorrected_top9 = load_top9(str(REPO / "Figures_notebook" / "results" / "figure6_multiome_fa_drift" / "instability_genes_ExcNeuron.csv"))
shipped_cc_top9 = load_top9(str(REPO / "Figures_notebook" / "results" / "figure6_multiome_fa_drift_cc" / "instability_genes_cc_ExcNeuron.csv"))
